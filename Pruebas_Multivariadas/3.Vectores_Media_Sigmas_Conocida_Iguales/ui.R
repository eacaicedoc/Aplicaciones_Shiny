...
shinyUI(pageWithSidebar(
  headerPanel(title=HTML("Prueba de hipótesis sobre dos vectores &mu; Normal multivariada 
                         &Sigma;<sub>1</sub>= &Sigma;<sub>2</sub>=&Sigma; Conocida"),
...
#-----------------Seleccionar los nombres de las columnas de la base de datos-----------------------------
  ...
  #-----------------------Manera de ingreasar la matriz de varianza covarianza----------------------------
    h4(HTML("Ingrese el valor de referencia &sum; para probar
                  H<sub>0</sub>: &mu;<sub>1</sub> = &mu;<sub>2</sub>.")),
    p(strong( "Escriba los valores de la matriz separados por un espacio, para asignar valores a la siguiente 
